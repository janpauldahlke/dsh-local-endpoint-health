...
function MetricsBlock({ metrics }) {
  ...
  const anyGauge = metrics.requestsDeferred !== null || metrics.requestsProcessing !== null || metrics.contextHighWater !== null;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...block, opacity: metrics.fresh ? 1 : 0.55 }, children: [
    ...
    specRows && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      perPos.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        Row,
        {
          label: "per-pos \xB7 last",
          value: perPos.map((p) => `p${p.position} ${p.acceptance}`).join(" \xB7 ")
        }
      )
    ] }),
